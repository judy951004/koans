...
public class AboutDates {
    ...
    public void dateToString() {
        assertEquals(date.toString(), "Sat Mar 03 21:33:21 GMT+09:00 1973");
    }
    ...
    public void changingDateValue() {
        ...
        assertEquals(date.toString(), "Sat Mar 03 22:33:21 GMT+09:00 1973");
    }
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), "Tue Apr 03 22:33:21 GMT+09:00 1973");
    }
    ...
    public void usingRollToChangeDatesDoesntWrapOtherFields() {
        ...
        assertEquals(cal.getTime().toString(), "Sat Mar 03 22:33:21 GMT+09:00 1973");
    }
    ...
    public void usingDateFormatToFormatDateFull() {
        ...
        assertEquals(formattedDate, "1973년 3월 3일 토요일");
    }
    ...
    public void usingDateFormatToParseDates() throws ParseException {
        ...
        assertEquals(date2.toString(), "Sat Jan 01 00:00:00 GMT+09:00 2000");
